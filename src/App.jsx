            ...
            {projects.map((p, i) => (
              <Reveal key={p.title} delay={i * 70}>
                <a className={`project ${p.className}`} href={p.href} target="_blank" rel="noreferrer">
                  <div className="project-art"><div className="art-window"><div className="art-bar"/><div className="art-lines"/><div className="art-card"/><div className="art-pill"/></div></div>
